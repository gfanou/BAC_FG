$(document).ready(
    function()
    {
        ...
        function showMyBac()
        {
            ...
            var numberOfBeers = parseFloat($("#numberOfBeers").val());

            // Number of glass of Wine consumed
            var numberOfWine = parseFloat($("#numberOfWine").val());


            // Number of shots consumed
            var numOfShots = parseFloat($("#numOfShots").val());
